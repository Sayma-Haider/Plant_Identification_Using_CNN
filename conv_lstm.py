# -*- coding: utf-8 -*-
"""conv_lstm_leaves.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Frm1hcyV2A7CjNScdOPNnJJA_ftvI0yo
"""
...
train_path = '/content/gdrive/MyDrive/Colab Notebooks/Leaves/train'
valid_path = '/content/gdrive/MyDrive/Colab Notebooks/Leaves/val'
test_path = '/content/gdrive/MyDrive/Colab Notebooks/Leaves/test'

#train_batches = ImageDataGenerator(preprocessing_function=tf.keras.applications.resnet.preprocess_input) \
 #   .flow_from_directory(directory=train_path, target_size=(224,224), classes=['betel_leaf', 'canna_indica', 'lantana', 'starfruit', 'sugarpalm'], batch_size=3045)
valid_batches = ImageDataGenerator(preprocessing_function=tf.keras.applications.xception.preprocess_input) \
    .flow_from_directory(directory=valid_path, target_size=(224,224), classes=['betel_leaf', 'canna_indica', 'lantana', 'starfruit', 'sugarpalm'], batch_size=380)
test_batches = ImageDataGenerator(preprocessing_function=tf.keras.applications.xception.preprocess_input) \
    .flow_from_directory(directory=test_path, target_size=(224,224), classes=['betel_leaf', 'canna_indica', 'lantana', 'starfruit', 'sugarpalm'], batch_size=380, shuffle=False)
...
def augment_data(train_path, batch_size):
    ...
    train_batches = train_datagen.flow_from_directory(
        ...
        target_size=(224,224),
        classes=['betel_leaf', 'canna_indica', 'lantana', 'starfruit', 'sugarpalm'],
...
import itertools
cm_plot_labels = ['betel_leaf', 'canna_indica', 'lantana', 'starfruit', 'sugarpalm']
plot_confusion_matrix(cm=cm, classes=cm_plot_labels, title='Confusion Matrix')

y_true=test_batches.classes
y_pred=np.argmax(predictions, axis=-1)
target_names = ['betel_leaf', 'canna_indica', 'lantana', 'starfruit', 'sugarpalm']
print(classification_report(y_true, y_pred, target_names=target_names))

model = Sequential()


model.add(TimeDistributed(Conv2D(32, kernel_size=(3, 3), activation='relu'), input_shape=(None, 224, 224, 3)))
...
model.add(TimeDistributed(Dense(512, activation='relu', kernel_regularizer=regularizers.l1_l2(l1=1e-5,l2=1e-4),
